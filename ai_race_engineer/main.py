...
def run(
    ...
    effective_radio_effect = radio_effect if piper_model_path else None
    speaker = PiperSpeaker(piper_model_path=piper_model_path, radio_effect=effective_radio_effect) if piper_model_path else None
